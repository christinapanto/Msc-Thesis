...
{
       0,     0,     3,     4,     7,     9,    12,    13,    19,    21,
      25,    26,    27,    32,    34,    35,    40,    42,    45,    47,
      49,    51,    52,    56,    57,    60,    65,    67,    70,    73,
      74
};
...
{
      15,     0,    -1,    -1,    16,    17,    -1,    18,    -1,    17,
      18,    -1,    -1,     6,    19,     7,    20,     9,    -1,    21,
      -1,    20,    10,    21,    -1,    -1,    -1,    22,    24,    23,
      28,    -1,    26,    -1,    -1,    24,    11,    25,    26,    -1,
      27,    -1,    26,    27,    -1,     6,    -1,     4,    -1,     3,
      -1,    -1,    12,    29,    13,    -1,    -1,    29,    30,    -1,
      31,     5,    31,     9,    -1,    32,    -1,    31,    32,    -1,
      27,    33,    -1,    -1,     8,    -1
};
...
{
       0,    45,    45,    45,    51,    54,    60,    59,    72,    75,
      81,    87,    81,    92,    97,    95,   105,   108,   113,   117,
     121,   125,   128,   133,   136,   141,   148,   151,   156,   160,
     163
};
#endif
...
{
  "$end", "error", "$undefined", "CONST", "TERM", "COMP", "NTERM",
  "YELDS", "A_SPEC", "';'", "'|'", "'#'", "'{'", "'}'", "$accept", "Gramm",
  "@1", "Productions", "Production", "@2", "RightSides", "RightSide", "@3",
  "@4", "Expressions", "@5", "Atoms", "Atom", "ListOfConstraints",
  "Constraints", "Constraint", "AtomSpecifications", "AtomSpecification",
  "Specification", 0
};
#endif
...
{
       2,     0,     0,     1,     6,     3,     4,     0,     5,    10,
       0,     8,     0,     7,    10,    20,    19,    18,    11,    13,
      16,     9,    14,    21,    17,     0,    23,    12,    15,     0,
      22,    29,    24,     0,    26,    30,    28,     0,    27,     0,
      25
};
...
{
      -1,     1,     2,     5,     6,     7,    10,    11,    12,    23,
      18,    25,    19,    31,    27,    29,    32,    33,    34,    36
};
...
{
     -26,     3,    17,   -26,   -26,    17,   -26,    19,   -26,   -26,
      -4,   -26,    18,   -26,   -26,   -26,   -26,   -26,    16,    18,
     -26,   -26,   -26,    13,   -26,    18,   -26,   -26,    18,    -2,
     -26,    20,   -26,    14,   -26,   -26,   -26,    18,   -26,     6,
     -26
};
...
{
     -26,   -26,   -26,   -26,    24,   -26,   -26,    21,   -26,   -26,
     -26,   -26,     5,   -12,   -26,   -26,   -26,    -6,   -25,   -26
};
...
{
      20,    15,    16,     3,    17,    13,    14,    24,    38,    15,
      16,    30,    17,    20,    38,    40,    24,    15,    16,    37,
      17,    15,    16,     4,    17,    26,     9,    22,    35,     8,
      28,    39,     0,     0,     0,    21
};

static const yytype_int8 yycheck[] =
{
      12,     3,     4,     0,     6,     9,    10,    19,    33,     3,
       4,    13,     6,    25,    39,     9,    28,     3,     4,     5,
       6,     3,     4,     6,     6,    12,     7,    11,     8,     5,
      25,    37,    -1,    -1,    -1,    14
};
...
{
       0,    15,    16,     0,     6,    17,    18,    19,    18,     7,
      20,    21,    22,     9,    10,     3,     4,     6,    24,    26,
      27,    21,    11,    23,    27,    25,    12,    28,    26,    29,
      13,    27,    30,    31,    32,     8,    33,     5,    32,    31,
       9
};
